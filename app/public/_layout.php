    ...
    if ($user) {
        ...
        $isApi = in_array($currentPage, ['api_keys.php', 'mcp_setup.php'], true);
	        ...
	        $nav = '<nav class="topnav">
	            <div class="nav-inner">
	                <a href="/dashboard.php" class="nav-brand" style="display:flex;align-items:center" title="BuyDomains"><img src="/logo.png" alt="BuyDomains By Network Solutions" style="height:36px;width:auto;display:block" /></a>
